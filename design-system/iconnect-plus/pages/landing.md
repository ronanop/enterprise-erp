...
- Body: Plus Jakarta Sans / DM Sans
- Hero headline: 48–72px desktop, generous line-height
...
- Primary: Request a demo / Book a conversation → `#2563FF` pill
- Secondary: Explore capabilities (outline)
- Sign in → `/login`
