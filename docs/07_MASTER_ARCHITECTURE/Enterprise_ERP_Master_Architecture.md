# iConnect Plus - Master Architecture Document

**Document type:** Solution Architecture & Shipping Master  
**Product:** iConnect Plus (iConnectPlus-aligned portfolio)  
