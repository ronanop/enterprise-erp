...
revision: str = "0517_seed_marketing_permissions"
down_revision: str | None = "0516_mkt_tables"
...
ROLE_SPECS: list[tuple[str, str, list[str]]] = [
    ...
    ("MARKETING_EDITOR", "Marketing Editor", MARKETING_EDITOR_PERMISSIONS),
...
def downgrade() -> None:
    ...
    for code, _, _, _ in MARKETING_PERMISSIONS:
        conn.execute(
