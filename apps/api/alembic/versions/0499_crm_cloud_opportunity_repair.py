"""Repair missing cloud opportunity columns after CRM/main merge."""
...
revision: str = "0499_crm_cloud_opportunity_repair"
down_revision: str | None = "0498_prj_project_proc_order"
...
def upgrade() -> None:
    ...
    op.execute(
        ...
        CHECK (category IN (
            'boq','sow','oem_quote','customer_po','vendor_quote','vendor_invoice','contract','other'
        ))
        """
    )
