"""Seed warranty claim permissions onto existing quality roles."""
...
revision: str = "0509_seed_qm_warranty_permissions"
down_revision: str | None = "0508_qm_warranty_claim"
...
NEW_PERM_ROWS = [row for row in QM_PERMISSIONS if row[0] in set(QM_WARRANTY_PERMISSIONS)]
...
def downgrade() -> None:
    conn = op.get_bind()
    for code in QM_WARRANTY_PERMISSIONS:
        conn.execute(
            sa.text(
                """
