"""Idempotent catch-up seed for Phase 1-6 quality workflow definitions."""
...
revision: str = "0513_seed_qm_phase16_workflows"
down_revision: str | None = "0512_seed_qm_phase16_permissions"
...
WORKFLOWS: list[tuple[str, str, str, list[tuple[int, str, str, str]]]] = [
    (
        ...
        "qm_ppap",
        [
            (1, "QUALITY_ENGINEER", "Quality Engineer Submit", "role"),
    ...
    (
        ...
        "qm_scar",
        [
            (1, "QUALITY_ENGINEER", "Quality Engineer Issue", "role"),
            (2, "QUALITY_MANAGER", "Quality Manager Verify", "role"),
        ],
    ),
]
