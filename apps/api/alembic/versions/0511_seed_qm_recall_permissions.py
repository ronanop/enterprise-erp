"""Seed recall permissions onto existing quality roles."""
...
revision: str = "0511_seed_qm_recall_permissions"
down_revision: str | None = "0510_qm_recall"
...
NEW_PERM_ROWS = [row for row in QM_PERMISSIONS if row[0] in set(QM_RECALL_PERMISSIONS)]
...
def downgrade() -> None:
    conn = op.get_bind()
    for code in QM_RECALL_PERMISSIONS:
        conn.execute(
            sa.text(
                """
