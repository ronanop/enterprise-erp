"""Seed hr.management_group permissions and grant to HR Admin / HR Executive."""
...
from modules.hr.permissions import HR_ADMIN_PERMISSIONS, HR_EXECUTIVE_PERMISSIONS, HR_PERMISSIONS

revision: str = "0464_hr_mgmt_group_perms"
down_revision: str | None = "0463_hr_management_group"
