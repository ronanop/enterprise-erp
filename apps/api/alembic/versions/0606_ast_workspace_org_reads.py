"""Grant Asset roles master/org read permissions for Configuration + import."""
...
revision: str = "0606_ast_workspace_org_reads"
down_revision: str | None = "0605_erp_admin_vs_all_modules"
