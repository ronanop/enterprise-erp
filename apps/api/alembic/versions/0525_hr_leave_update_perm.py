"""Seed hr.leave:update and grant to HR role packs."""
...
revision: str = "0525_hr_leave_update_perm"
down_revision: str | None = "0524_prj_po_queue_handoff"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None

NEW_CODES = {"hr.leave:update"}
