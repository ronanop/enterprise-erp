"""Seed VIN trace permissions onto existing quality roles."""
...
revision: str = "0507_seed_qm_vin_permissions"
down_revision: str | None = "0506_qm_vin_trace_component"
...
NEW_PERM_ROWS = [row for row in QM_PERMISSIONS if row[0] in set(QM_VIN_PERMISSIONS)]
...
def downgrade() -> None:
    conn = op.get_bind()
    for code in QM_VIN_PERMISSIONS:
        conn.execute(
            sa.text(
                """
