"""Seed QM_PPAP_APPROVAL workflow definition."""
...
revision: str = "0499_seed_qm_ppap_workflow"
down_revision: str | None = "0498_seed_qm_ppap_pfmea_permissions"
