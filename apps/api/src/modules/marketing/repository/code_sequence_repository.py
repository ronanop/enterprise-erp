"""Marketing document code sequences."""
...
from modules.marketing.domain.enums import CODE_PREFIXES, MktEntityType
...
class CodeSequenceRepository:
    ...
    def next_code(self, entity: MktEntityType, company_id: UUID, model, code_column: str) -> str:
