"""OrderViewService application service."""
...
class OrderViewService:
    ...
    def get(self, ctx: TenantContext, row_id: UUID) -> PtOrderView:
        row = self._repo.get(ctx, row_id)
        if row is None:
            raise NotFoundException("OrderViewService not found")
        return row
