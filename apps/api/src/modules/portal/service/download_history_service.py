"""DownloadHistoryService application service."""
...
class DownloadHistoryService:
    ...
    def get(self, ctx: TenantContext, row_id: UUID) -> PtDownloadHistory:
        row = self._repo.get(ctx, row_id)
        if row is None:
            raise NotFoundException("DownloadHistoryService not found")
        return row
    ...
    def create(self, ctx: TenantContext, company_id: UUID | None = None, **fields):
        ...
        self._audit.log_entity_change(
            ...
            entity_name="pt_download_history",
            entity_id=row.id,
            operation="create",
