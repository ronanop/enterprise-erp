...
from modules.document.repository.notification_repository import NotificationRepository
...
class NotificationService:
    ...
    def get(self, ctx: TenantContext, row_id: UUID) -> DocNotification:
