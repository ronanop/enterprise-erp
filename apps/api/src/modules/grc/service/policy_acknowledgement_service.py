"""PolicyAcknowledgementService application service."""
...
class PolicyAcknowledgementService:
    ...
    def get(self, ctx: TenantContext, row_id: UUID) -> GrcPolicyAcknowledgement:
        row = self._repo.get(ctx, row_id)
        if row is None:
            raise NotFoundException("PolicyAcknowledgementService not found")
        return row
    ...
    def create(self, ctx: TenantContext, company_id: UUID | None = None, **fields):
        ...
        self._audit.log_entity_change(
            ...
            entity_name="grc_policy_acknowledgement",
            entity_id=row.id,
            operation="create",
