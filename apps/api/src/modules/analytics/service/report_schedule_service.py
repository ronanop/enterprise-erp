"""ReportScheduleService application service."""
...
from modules.analytics.repository.report_schedule_repository import ReportScheduleRepository
...
class ReportScheduleService:
    ...
    def get(self, ctx: TenantContext, row_id: UUID) -> BiReportSchedule:
        row = self._repo.get(ctx, row_id)
        if row is None:
            raise NotFoundException("ReportScheduleService not found")
        return row
    ...
    def create(self, ctx: TenantContext, company_id: UUID | None = None, **fields):
        ...
        self._audit.log_entity_change(
            ...
            entity_name="bi_report_schedule",
            entity_id=row.id,
            operation="create",
