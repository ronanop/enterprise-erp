...
from modules.analytics.repository.report_repository import ReportRepository
...
class ReportService:
    ...
    def get(self, ctx: TenantContext, row_id: UUID) -> BiReport:
    ...
    def create(self, ctx: TenantContext, company_id: UUID | None = None, **fields):
        cid = self._scope.resolve_company_id(ctx, company_id)
        doc = self._numbers.generate(AnalyticsEntityType.REPORT, cid, BiReport, "report_number")
        return self._repo.create(ctx, company_id=cid, report_number=doc, **fields)
