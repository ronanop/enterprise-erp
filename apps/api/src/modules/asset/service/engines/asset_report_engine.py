...
class AssetReportEngine:
    ...
    def shape_dashboard(
        ...
        *,
        ...
        analytics_kpis: dict[str, Any] | None = None,
        by_status: list[dict[str, Any]] | None = None,
        by_operational_status: list[dict[str, Any]] | None = None,
        ...
        return {
            ...
            "kpis": kpis,
            "analytics_kpis": analytics_kpis or {},
            "by_status": by_status or [],
            "by_operational_status": by_operational_status or [],
