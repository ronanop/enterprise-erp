"""SupportShiftService application service."""
...
class SupportShiftService:
    ...
    def get(self, ctx: TenantContext, row_id: UUID) -> HdSupportShift:
        row = self._repo.get(ctx, row_id)
        if row is None:
            raise NotFoundException("SupportShiftService not found")
        return row
