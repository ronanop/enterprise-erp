 ...
 * site-signal.top, popups-script.js, etc.). Next.js 16 devtools treats their console.error
 * as app errors. Install from a client component after mount — never as a <head> script.
 * Extensions rewrite the first SSR <script> (id/src/innerHTML) and cause hydration mismatches.
 */
const NOISE_RE =
