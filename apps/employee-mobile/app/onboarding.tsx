...
const styles = StyleSheet.create({
  ...
  featureIcon: { position: "absolute", alignItems: "center", justifyContent: "center", width: 48, height: 48, borderRadius: 14, backgroundColor: "rgba(255,255,255,0.9)", shadowColor: "#0b1c30", shadowOpacity: 0.14, shadowRadius: 10, shadowOffset: { width: 0, height: 4 }, elevation: 4 },
  walletIcon: { right: -4, top: -10 },
  calendarIcon: { left: -6, top: "47%" },
  sparkleIcon: { right: -8, bottom: 40 },
  prompt: { position: "absolute", flexDirection: "row", alignItems: "center", gap: 6, paddingHorizontal: 12, paddingVertical: 8, borderRadius: 999, backgroundColor: "rgba(255,255,255,0.92)", shadowColor: "#0b1c30", shadowOpacity: 0.14, shadowRadius: 10, shadowOffset: { width: 0, height: 4 }, elevation: 4 },
