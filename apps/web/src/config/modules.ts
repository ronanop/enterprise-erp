...
export const erpModules: ErpModule[] = [
  ...
  },
  {
    ...
    resources: [
      ...
      },
      {
        key: "pfmeas",
        title: "PFMEA",
        description: "Process FMEA and RPN",
      ...
      },
      {
        key: "vin-traces",
        title: "VIN Traces",
        description: "Vehicle VIN as-built traceability",
        apiPath: "/quality/vin-traces",
      },
      {
        key: "defects",
        title: "Defects",
      ...
      },
      {
        key: "ppaps",
        title: "PPAP",
        description: "Part production approval packages",
        apiPath: "/quality/ppaps",
      },
      {
      ...
      },
      {
        ...
        description: "VIN-linked warranty claims",
        apiPath: "/quality/warranty-claims",
      },
      {
        key: "recalls",
        title: "Recalls",
        description: "Recall campaigns by product and VIN range",
        apiPath: "/quality/recalls",
      },
      {
        key: "audits",
        title: "Audits",
      ...
      },
      {
        key: "reports",
        title: "Reports",
        description: "Inspection, NCR, CAPA, and KPI summaries",
        apiPath: "/quality/reports/kpi-dashboard",
        listable: false,
      },
    ],
  },
  ...
  },
  {
    ...
    resources: [
      ...
      {
        key: "report-executions",
        title: "Report Executions",
        description: "Report run history",
        apiPath: "/analytics/report-executions",
      },
      {
        key: "dataset-sources",
        title: "Dataset Sources",
        description: "Source connectors",
        apiPath: "/analytics/dataset-sources",
      },
      {
        key: "fact-tables",
        title: "Fact Tables",
        description: "Star schema fact tables",
        apiPath: "/analytics/fact-tables",
      },
      {
        key: "data-refreshes",
        title: "Data Refreshes",
        description: "ETL refresh jobs",
        apiPath: "/analytics/data-refreshes",
      },
      {
        key: "alert-notifications",
        title: "Alert Notifications",
        description: "Fired threshold alerts",
        apiPath: "/analytics/alert-notifications",
      },
      {
        key: "query-history",
        title: "Query History",
        description: "Analytics query audit",
        apiPath: "/analytics/query-history",
      },
      {
        key: "usage-audits",
        title: "Usage Audits",
        description: "BI usage tracking",
        apiPath: "/analytics/usage-audits",
      },
      {
        key: "executive",
        title: "Executive View",
        description: "CEO/CFO/COO/CHRO cross-module KPIs",
        apiPath: "/analytics/dashboards",
        listable: false,
      },
    ],
