...
function BrandMark({ light = false }: { light?: boolean }) {
  return (
    ...
    >
      <span
        aria-hidden
        className="relative flex size-8 items-center justify-center overflow-hidden rounded-xl bg-white text-black shadow-[0_0_24px_-6px_rgba(255,255,255,0.35)] transition-transform duration-200 group-hover:scale-[1.03]"
      >
        <span className="font-[family-name:var(--font-icp-display),sans-serif] text-[11px] font-bold tracking-tight">
          iC
        </span>
      </span>
      <span
