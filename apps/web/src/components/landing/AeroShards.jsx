...
@group(0) @binding(0) var view: ViewParams;
...
@group(0) @binding(0) var sceneTexture: texture_2d;
@group(0) @binding(1) var sceneSampler: sampler;
@group(0) @binding(2) var post: PostParams;
...
@group(0) @binding(0) var bloomTexture: texture_2d;
@group(0) @binding(1) var linearSampler: sampler;
@group(0) @binding(2) var blur: BlurParams;
...
@group(0) @binding(2) var style: StyleParams;
...
@group(0) @binding(3) var asciiCells: texture_2d;
...
@group(0) @binding(0) var sceneTexture: texture_2d;
@group(0) @binding(1) var bloomTexture: texture_2d;
@group(0) @binding(2) var linearSampler: sampler;
@group(0) @binding(3) var post: PostParams;
