...
> = {
  oem: {
    title: "OEM / Brand",
    description: "Brand / manufacturer master (not the procurement vendor). Add new OEMs from the lead form.",
    subtitle: "OEM / brand partners",
    primary: (l) => l.oem_name,
    secondary: (l) => l.oem_contact_person || l.oem_contact_email || l.oem_contact_number,
    columns: ["OEM / Brand", "Contact"],
    dedupeByPrimary: true,
  },
  distributor: {
    title: "Distributor / Vendor",
    description: "Same party as Vendor in Procurement. Captured on sales leads and used for POs.",
    subtitle: "Distributors (= vendors) from leads",
    primary: (l) => l.distributor_name,
    secondary: (l) =>
      l.distributor_contact_person || l.distributor_contact_email || l.distributor_contact,
    columns: ["Distributor / Vendor", "Contact"],
    dedupeByPrimary: true,
  },
  entity: {
    title: "Entity",
